...
- **Skills** (`shared/skills/`) — path-promoted CLIs for Tavily, Exa, arXiv, congress.gov, BTC price, ntfy, todo; humanizer prose editing; how-to-debate Socratic argumentation; browser automation via `$B` (kept in the repo, no longer wired into presets). → [Skills](skills.md)
